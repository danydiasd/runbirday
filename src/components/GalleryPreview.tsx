...
const galleryItems = [
  ...
  { image: '/images/DSC_6858.jpg', alt: 'A entrada para os De repente 30', label: 'Memórias' },
  { image: '/images/DSC_6843.jpg', alt: 'Detalhes de uma noite feita para recordar', label: 'Detalhes' },
  { image: '/images/DSC_6859.jpg', alt: 'Detalhes que fazem a diferença em um momento', label: 'Detalhes' },
